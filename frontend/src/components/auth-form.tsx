          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <label className="space-y-2">
                ...
                <input type="email" className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} />
              </label>
              {mode === 'register' && (
                <label className="space-y-2">
