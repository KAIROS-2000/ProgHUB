...
export function AuthForm({ mode, options }: { mode: 'login' | 'register'; options?: AuthOptions }) {
  ...
  return (
    <main className="grid min-h-screen place-items-center px-4 py-8 sm:px-6 sm:py-10">
      <div className="grid w-full max-w-6xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
        <section className="order-2 codequest-card grid-bg overflow-hidden p-6 text-slate-900 sm:p-8 lg:order-1">
          ...
          <h1 className={`mt-3 font-black leading-[1.05] tracking-[-0.03em] sm:text-4xl ${mode === 'login' ? 'text-[1.75rem] whitespace-nowrap' : 'text-[1.75rem]'}`}>
        ...
        <section className="order-1 codequest-card p-6 sm:p-8 lg:order-2">
