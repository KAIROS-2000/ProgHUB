			...
			<section className='mx-auto grid max-w-7xl gap-8 px-6 py-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center'>
				<div>
					...
					<div className='mt-8 flex flex-wrap gap-4'>
						<Link
							href='/auth/register'
							className='rounded-full bg-slate-900 px-6 py-3 font-semibold text-white shadow-xl shadow-slate-300'
						>
							Начать бесплатно
						</Link>
						<Link
							href='/roadmap'
							className='rounded-full bg-white px-6 py-3 font-semibold text-slate-900 shadow-md'
						>
							Смотреть roadmap
						</Link>
						<Link
							href='/parent'
							className='rounded-full bg-violet-100 px-6 py-3 font-semibold text-violet-800 shadow-md'
						>
				...
				<div className='codequest-card grid-bg overflow-hidden p-8'>
