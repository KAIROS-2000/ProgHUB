...
class User(db.Model):
    ...
    avatar = db.Column(db.String(120), nullable=False, default='robot-blue')
    companion = db.Column(db.String(120), nullable=False, default='Кодик-робот')
    ...
    posts = db.relationship('ForumPost', back_populates='author', cascade='all, delete-orphan')
